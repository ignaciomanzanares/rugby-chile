        ...
        <AuthProvider>
          ...
          <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 px-4 py-2 rounded-lg border border-border hover:border-pink-500/60 hover:bg-pink-500/10 text-muted-foreground hover:text-pink-400 text-sm font-semibold transition-all group"
            >
              ...
              <span className="text-muted-foreground/70 group-hover:text-pink-500/70 text-xs font-normal">@arusa_rugby</span>
            </a>
          </div>
          </footer>
        </AuthProvider>
