...
export async function simulateSeason(sims = 20000, seed = 12345): Promise<SeasonProjection> {
  ...
  // Tabla base: el standings OFICIAL de Leverade (reconciliado), que trae los
  // puntos de bonus EXACTOS (bonus ofensivo por 4 tries, no aproximado). Calcular
  // la tabla desde los scores del feed con un proxy de 25+ pts sobre-contaba el
  // bonus y divergía de la tabla real, así que preferimos la oficial.
